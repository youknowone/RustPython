...
pub struct PyNumberMethods {
    ...
    pub right_add: BinaryFunc,
    pub right_subtract: BinaryFunc,
    pub right_multiply: BinaryFunc,
    pub right_remainder: BinaryFunc,
    pub right_divmod: BinaryFunc,
    pub right_power: BinaryFunc,
    pub right_lshift: BinaryFunc,
    pub right_rshift: BinaryFunc,
    pub right_and: BinaryFunc,
    pub right_xor: BinaryFunc,
    pub right_or: BinaryFunc,
    ...
    pub right_floor_divide: BinaryFunc,
    pub right_true_divide: BinaryFunc,
    ...
    pub right_matrix_multiply: BinaryFunc,
...
impl PyNumberMethods {
    ...
    pub const NOT_IMPLEMENTED: PyNumberMethods = PyNumberMethods {
        ...
        right_add: AtomicCell::new(None),
        right_subtract: AtomicCell::new(None),
        right_multiply: AtomicCell::new(None),
        right_remainder: AtomicCell::new(None),
        right_divmod: AtomicCell::new(None),
        right_power: AtomicCell::new(None),
        right_lshift: AtomicCell::new(None),
        right_rshift: AtomicCell::new(None),
        right_and: AtomicCell::new(None),
        right_xor: AtomicCell::new(None),
        right_or: AtomicCell::new(None),
        ...
        right_floor_divide: AtomicCell::new(None),
        right_true_divide: AtomicCell::new(None),
        ...
        right_matrix_multiply: AtomicCell::new(None),
    ...
    pub fn get_binary_op(&self, op_slot: &PyNumberBinaryOpSlot) -> PyResult<&BinaryFunc> {
        ...
        let binary_op = match op_slot {
            ...
            Xor => &self.xor,
            Or => &self.or,
            RightAdd => &self.right_add,
            RightSubtract => &self.right_subtract,
            RightMultiply => &self.right_multiply,
            RightRemainder => &self.right_remainder,
            RightDivmod => &self.right_divmod,
            RightPower => &self.right_power,
            RightLshift => &self.right_lshift,
            RightRshift => &self.right_rshift,
            RightAnd => &self.right_and,
            RightXor => &self.right_xor,
            RightOr => &self.right_or,
            ...
            RightFloorDivide => &self.right_floor_divide,
            RightTrueDivide => &self.right_true_divide,
            ...
            RightMatrixMultiply => &self.right_matrix_multiply,
