...
pub use windows_sys::Win32::Networking::WinSock::{
    ...
    SOCKET_ERROR as SOCKET_ERROR_CODE, SOL_IP, SOL_SOCKET, TCP_MAXSEG, TCP_NODELAY, WSAEBADF,
    WSAECONNABORTED, WSAECONNRESET, WSAEINTR, WSAENOTSOCK, WSAEWOULDBLOCK, getprotobyname,
